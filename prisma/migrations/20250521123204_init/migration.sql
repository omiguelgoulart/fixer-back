...
-- CreateEnum
CREATE TYPE "TipoUsuario" AS ENUM ('GESTOR', 'GERENTE', 'TECNICO');
...
-- AddForeignKey
ALTER TABLE "areas" ADD CONSTRAINT "areas_id_planta_fkey" FOREIGN KEY ("id_planta") REFERENCES "plantas"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "sistemas" ADD CONSTRAINT "sistemas_id_area_fkey" FOREIGN KEY ("id_area") REFERENCES "areas"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ativos" ADD CONSTRAINT "ativos_id_sistema_fkey" FOREIGN KEY ("id_sistema") REFERENCES "sistemas"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "fotos" ADD CONSTRAINT "fotos_ativoId_fkey" FOREIGN KEY ("ativoId") REFERENCES "ativos"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "falhas" ADD CONSTRAINT "falhas_id_ativo_fkey" FOREIGN KEY ("id_ativo") REFERENCES "ativos"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "subativos" ADD CONSTRAINT "subativos_id_ativo_fkey" FOREIGN KEY ("id_ativo") REFERENCES "ativos"("id") ON DELETE CASCADE ON UPDATE CASCADE;
